...
public class CarRentalService {
    ...
    private List<Car> InitCars(int amount)
    {
    ...
    public Car rentCarToCustomer(Customer customer)
    {
        ...
        bestMatch.ifPresent(entry -> {
            ...
            selectedCar.RentedUntil = selectedCar.RentedFrom.plusHours(customer.rentalDuration);
            System.out.println("Rented car: " + selectedCar.id + " to customer: " + customer.getFullName());
        });
